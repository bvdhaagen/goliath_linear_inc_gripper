...
std::vector<hardware_interface::StateInterface> RobotSystem::export_state_interfaces()
 ...
 state_interfaces.emplace_back("Slider 22", "position", &gripper_positions_[0]);
 state_interfaces.emplace_back("Slider 23", "position", &gripper_positions_[1]);
...
std::vector<hardware_interface::CommandInterface> RobotSystem::export_command_interfaces()
{
 ...
 command_interfaces.emplace_back("Slider 22", "position", &gripper_commands_[0]);
 command_interfaces.emplace_back("Slider 23", "position", &gripper_commands_[1]);
